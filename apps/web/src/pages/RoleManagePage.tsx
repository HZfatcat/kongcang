...
const PAGE_PERM_DEFS: PagePermDef[] = [
  ...
  { path: '/udesk/votes', label: '评价分析', category: 'Udesk 数据分析', permType: 'op' },
  { path: '/udesk/metrics', label: '会话指标', category: 'Udesk 数据分析', permType: 'op' },
  { path: '/udesk/tickets', label: '工单分析', category: 'Udesk 数据分析', permType: 'op' },
  { path: '/udesk/heatmap', label: '时段热力图', category: 'Udesk 数据分析', permType: 'view' },
  { path: '/udesk/sessions', label: '咨询详情', category: 'Udesk 数据分析', permType: 'op' },
