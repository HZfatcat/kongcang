...
export async function fetchUdescOverview(params: { startDate?: string; endDate?: string }) {
  const resp = await apiClient.get<UdescOverview>('/udesk/overview', { params });
  return resp.data;
}

export async function fetchUdescTree(params: { startDate?: string; endDate?: string }) {
  const resp = await apiClient.get<UdescTreeNode[]>('/udesk/tree', { params });
  return resp.data;
}

export async function fetchUdescDailyAgentStats(params: { startDate?: string; endDate?: string }) {
  const resp = await apiClient.get<UdescDailyAgentStats>('/udesk/daily-agent-stats', { params });
  return resp.data;
}

export async function fetchUdescDailyRatingStats(params: { startDate?: string; endDate?: string }) {
  const resp = await apiClient.get<UdescDailyRatingStats>('/udesk/daily-rating-stats', { params });
  return resp.data;
}
...
export async function fetchUdescSessions(params: {
  ...
  const resp = await apiClient.get<UdescSessionListResp>('/udesk/sessions', { params });
...
export async function fetchUdescVotes(params: {
  ...
  const resp = await apiClient.get<UdescVoteListResp>('/udesk/votes', { params });
  return resp.data;
}

// ========== 客服管理 ==========
export async function fetchUdescAgents(params?: { enabled?: boolean }) {
  const resp = await apiClient.get<UdescAgentListResp>('/udesk/agents', { params });
  return resp.data;
}

export async function fetchUdescAgentPerformance(agentId: string, params: { startDate?: string; endDate?: string }) {
  const resp = await apiClient.get<UdescAgentPerformance>(`/udesk/agents/${encodeURIComponent(agentId)}/performance`, { params });
  return resp.data;
}
...
export async function fetchUdescMetrics(params: {
  ...
  const resp = await apiClient.get<UdescMetricsListResp>('/udesk/metrics', { params });
  return resp.data;
}

export async function fetchUdescMetricsSummary(params: { startDate?: string; endDate?: string; agentId?: string }) {
  const resp = await apiClient.get<UdescMetricsSummary>('/udesk/metrics/summary', { params });
  return resp.data;
}
...
export async function fetchUdescTickets(params: {
  ...
  const resp = await apiClient.get<UdescTicketListResp>('/udesk/tickets', { params });
  return resp.data;
}
...
export async function fetchUdescTicketSummary(params: {
  ...
  const resp = await apiClient.get<UdescTicketSummary>('/udesk/tickets/summary', { params });
  return resp.data;
}
...
export async function fetchUdescTicketDailyStats(params: {
  ...
  const resp = await apiClient.get<UdescTicketDailyStats>('/udesk/tickets/daily-stats', { params });
  return resp.data;
}
...
export async function fetchUdescHeatmap(params: {
  ...
  const resp = await apiClient.get<UdescHeatmap>('/udesk/heatmap', { params });
  return resp.data;
}
